...
public class BlackListController {
	...
	@PostMapping()
	public DataResult<AddBlackListResponse> add(@Valid @RequestBody AddBlackListRequest addBlackListRequest){
		return this.blackListService.add(addBlackListRequest);
	}
