...
public class ValidationMessages {
    ...
    public static class User {
        ...
        public static final String FirstNameValid = "First name must be between 3 and 25 characters";
        public static final String LastNameBlank = "Last name cannot be blank";
        public static final String LastNameValid = "Last name must be between 3 and 25 characters";
    ...
    public static class Applicant{
    	public static final String IdBlank= "Id cannot be blank";
    	public static final String BlackListId= "BlackList id cannot be blank";
        public static final String AboutBlank = "About cannot be blank";
        public static final String AboutValid = "About must be between 5 and 100 characters";
    }

    public static class Employee{
        public static final String PositionBlank = "Position cannot be blank";
        public static final String PositionValid = "Position must be between 2 and 25 characters";
    }
